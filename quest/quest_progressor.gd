...
const PRESSURE_INCREASE_PER_CORRECT_ANSWER = QuestConstants.PRESSURE_INCREASE_PER_CORRECT_ANSWER
const PRESSURE_DECREASE_PER_WRONG_ANSWER =  QuestConstants.PRESSURE_DECREASE_PER_WRONG_ANSWER
const MAX_PRESSURE =  QuestConstants.MAX_PRESSURE
const MAX_ADDED_PROGRESS =  QuestConstants.MAX_ADDED_PROGRESS
